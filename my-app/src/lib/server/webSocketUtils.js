...
*/
export const onHttpServerUpgrade = (req, sock, head) => {//(req: IncomingMessage, sock: Duplex, head: Buffer) => {
...
export const createWSSGlobalInstance = () => {
  ...
  (globalThis)[GlobalThisWSS] = wss;//(globalThis as ExtendedGlobal)[GlobalThisWSS] = wss;
